...
def parse_command_line_args():
    try:
        import argparse
        parser = argparse.ArgumentParser(description='Liftover VCF file from b36 or hg18 to hg19',
...
if __name__ == '__main__':
    ...
    print("Lifting over...")
    subprocess.getstatusoutput("%s hg18.bed %s hg19.bed unmapped" % (args.liftover_binary, args.chain_file))
